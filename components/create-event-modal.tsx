...
export default function CreateEventModal({ isOpen, onClose, onSubmit, theme }: CreateEventModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="p-8 rounded-2xl w-full max-w-lg" style={{ backgroundColor: `var(--bg-secondary-${theme})`, border: `1px solid var(--border-${theme})` }}>
        <h2 className="text-2xl font-bold mb-6" style={{ color: `var(--text-primary-${theme})` }}>Create New Event</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select name="status" value={eventData.status} onChange={handleChange} className="w-full input-style">
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            <Button type="submit" style={{ backgroundColor: `var(--accent-1-${theme})`, color: 'white' }}>Create Event</Button>
          </div>
        </form>
      </div>
      <style jsx>{`
